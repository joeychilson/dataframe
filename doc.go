...
//
// Panics are reserved for invalid indexes, bounds, and incompatible positional
// values supplied to operations whose signatures cannot return errors. Dynamic
// schema operations, construction, joins, and record conversion return errors.
package dataframe
